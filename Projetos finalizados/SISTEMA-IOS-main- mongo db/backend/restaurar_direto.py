...
#  CONEXÃO MONGO DIRETA
client = MongoClient("mongodb+srv://jesielamarojunior_db_user:admin123@cluster0.vuho6l7.mongodb.net/IOS-SISTEMA-CHAMADA?retryWrites=true&w=majority")
...
updates = [
    # Fabiana - Instrutor Jd.Angela Microsoft Office
    ...
    # Marcus - Instrutor Jd.Angela Microsoft Office  
    ...
    # Ermerson - Instrutor Porto Alegre
...
for update in updates:
    user = db.users.find_one({"email": update["email"]})
    if user:
